...
export const gearItems = [
    ...
    { name:"Видеокамера", category:"Наблюдение", cost:100, description:"Запись видео и аудио", effect:"12 часов записи на щепку" },
    { name:"Грейферный пистолет", category:"Инструменты", cost:100, description:"Выстреливает гарпун с тросом до 30 м", effect:"Позволяет забираться на стены" },
    ...
    { name:"Драм-машина", category:"Развлечения", cost:500, description:"Электронные ударные", effect:"Требует усилитель" },
    { name:"Изолента", category:"Инструменты", cost:20, description:"Светящаяся в темноте лента", effect:"Для маркировки и временного ремонта" },
    { name:"Карманный усилитель", category:"Развлечения", cost:50, description:"Усилитель для инструментов", effect:"Работает 6 часов" },
    { name:"Компьютер", category:"Электроника", cost:50, description:"Ноутбук или ПК", effect:"Для работы с текстами и ДатаПулом" },
    ...
    { name:"Набор личной гигиены", category:"Личное", cost:20, description:"Зубная щётка, влажные салфетки и т.д.", effect:"Позволяет поддерживать опрятный вид" },
    ...
    { name:"Надувная кровать и спальный мешок", category:"Походное", cost:20, description:"Компактное спальное место", effect:"Позволяет спать с комфортом" },
    ...
    { name:"Очки виртуальности", category:"Электроника", cost:100, description:"Шлем для нетраннинга", effect:"Позволяет видеть архитектуру сети" },
    ...
    { name:"Сумка", category:"Разное", cost:20, description:"Прочная сумка", effect:"Для переноски вещей" },
    ...
    { name:"Шифратор/дешифратор", category:"Безопасность", cost:500, description:"Шифрует связь", effect:"Требуется для прослушивания зашифрованных каналов" }
];
