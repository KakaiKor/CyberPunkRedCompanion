...
export function renderSkills() {
    return `<div class="table-wrapper"><table class="cyber-table"><thead><tr><th>Навык</th><th>ХАР</th><th>Описание</th></tr></thead><tbody>
    ...
    <tr><td>Уклонение</td><td>ЛВК</td><td>Уклонение от атак</td></tr>
...
export function updateAllTables() {
    ...
    if(document.getElementById('cyber-detailed-table')) document.getElementById('cyber-detailed-table').innerHTML = renderCyberware(detailedCyberware);
    if(document.getElementById('cyber-detailed-table-gear')) document.getElementById('cyber-detailed-table-gear').innerHTML = renderCyberware(detailedCyberware);
}
